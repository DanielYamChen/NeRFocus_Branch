...
def train_step(model, config, rng, state, batch, lr, a=0, f=0.1, l=0.6, train_coc=0):
...
def main(unused_argv):
  ...
  pdataset_r3 = flax.jax_utils.prefetch_to_device(dataset_r3, 3)
  pdataset_r7 = flax.jax_utils.prefetch_to_device(dataset_r7, 3)
  pdataset_r15 = flax.jax_utils.prefetch_to_device(dataset_r15, 3)
  pdataset_r31 = flax.jax_utils.prefetch_to_device(dataset_r31, 3)
  pdataset_r51 = flax.jax_utils.prefetch_to_device(dataset_r51, 3)
